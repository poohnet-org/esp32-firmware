...
| Fast Timeout | Yes/No | Non-standard SLAC init timeout: two 10s attempts with one E/F wake-up cycle in between instead of 3x50s. EVs without ISO 15118 support (e.g. without a CCS charging plug) otherwise wait at least two minutes before the IEC 61851 fallback lets an AC charge start |
