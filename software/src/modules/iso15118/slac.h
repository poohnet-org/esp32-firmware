...
// CM_SLAC_PARM.REQ within TP_EV_SLAC_init (10s) of plug-in or wake-up, so any
// ISO 15118 capable EV should still match while EVs without PLC modem fall
// back to IEC 61851 after ~24s (2 x 10s + 1 x 4s State E/F) instead of ~158s
// (3 x 50s + 2 x 4s State E/F).
